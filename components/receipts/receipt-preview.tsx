            ...
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-muted-foreground">
                  {selectedCompany.businessDetails?.address && (
                    <div>{selectedCompany.businessDetails.address}</div>
                  )}
                  ...
                  {selectedCompany.businessDetails?.phone && (
                    <div>{selectedCompany.businessDetails.phone}</div>
                  )}
                  {selectedCompany.businessDetails?.email && (
                    <div>{selectedCompany.businessDetails.email}</div>
                  )}
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div>
                  ...
                  {receiptData.clientPhone && (
                    <div className="text-muted-foreground">{receiptData.clientPhone}</div>
                  )}
                  {receiptData.clientEmail && (
                    <div className="text-muted-foreground">{receiptData.clientEmail}</div>
                  )}
                </div>
              </div>
