      ...
      <>
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex flex-col justify-center items-center min-h-[60vh] text-center">
            ...
            <p className="text-muted-foreground mb-4">You need to set up a company before creating delivery notes.</p>
    ...
    <>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Fill in the details to create a new delivery note</p>
        </div>

        <DeliveryNoteForm userId={user.uid} companies={userData.companies} />
      </main>
    </>
  )
}
